// This page is to acknowledge items added to the cart.
"use client";
...
export default function CartAddItem({ itemId }: { itemId: string }) {
  ...
  // This is used to find items in the cart.
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 md:gap-4">
        <Card className="w-full rounded-none">
          <CardContent className="flex h-full items-center justify-center  gap-3 py-4">
            {/* This contains link that are added to the cart */}
            ...
            <div>
              ...
              {/* Show color and size of the added items in the card */}
              <p className="text-sm">
