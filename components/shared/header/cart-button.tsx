...
export default function CartButton() {
  ...
  // This helps us to get access to the items added in the shopping cart.
  const {
    cart: { items },
  } = useCartStore();

  const isCartSidebar = useCartSidebar();

  // This is used to get the count of the items in the cart.
